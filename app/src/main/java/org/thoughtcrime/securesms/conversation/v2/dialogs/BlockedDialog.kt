...
class BlockedDialog(private val recipient: Recipient, private val context: Context) : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog = createSessionDialog {
        ...
        val explanation = Phrase.from(context, R.string.communityJoinDescription).put(NAME, name).format() // ACL replaced
        //val explanation = resources.getString(R.string.blockUnblockDescription, name) // OG
