...
class ConversationActivityV2 : PassphraseRequiredActionBarActivity(), InputBarDelegate,
    ...
    fun useStringsTemp() {
        var s = "foo"
        s = resources.getString(R.string.disappearingMessagesUpdated)
        s = resources.getString(R.string.groupMemberLeft)
        s = resources.getString(R.string.adminMorePromotedToAdmin)
        s = resources.getString(R.string.adminTwoPromotedToAdmin)
        s = resources.getString(R.string.adminPromotedToAdmin)
        s = resources.getString(R.string.groupMemberMoreNew)
        s = resources.getString(R.string.groupRemovedMore)
        s = resources.getString(R.string.groupMemberTwoNew)
        s = resources.getString(R.string.groupRemovedTwo)
        s = resources.getString(R.string.groupMemberNew)
        s = resources.getString(R.string.searchMatches)
        s = resources.getString(R.string.members)
        s = resources.getString(R.string.callsCalledYou)
        s = resources.getString(R.string.disappearingMessagesChanged)
        s = resources.getString(R.string.disappearingMessagesSet)
        s = resources.getString(R.string.screenshotTaken )
        s = resources.getString(R.string.disappearingMessagesTurnedOff)
        s = resources.getString(R.string.adminRemovedUser)
        s = resources.getString(R.string.groupRemoved)
        s = resources.getString(R.string.attachmentsMedia)
        s = resources.getString(R.string.notificationsIosGroup)
        s = resources.getString(R.string.notificationsAndroidSystem)
        s = resources.getString(R.string.disappearingMessagesOneDay)
        s = resources.getString(R.string.disappearingMessagesOneHour)
        s = resources.getString(R.string.disappearingMessagesOneWeek)
        s = resources.getString(R.string.disappearingMessagesTwelveHours)
        s = resources.getString(R.string.disappearingMessagesTwelveH)
        s = resources.getString(R.string.disappearingMessagesOneD)
        s = resources.getString(R.string.disappearingMessagesOneH)
        s = resources.getString(R.string.disappearingMessagesOneW)
        s = resources.getString(R.string.disappearingMessagesTwoWeeks)
        s = resources.getString(R.string.disappearingMessagesTwoW)
        s = resources.getString(R.string.disappearingMessagesFiveMinutes)
        s = resources.getString(R.string.disappearingMessagesFiveM)
        s = resources.getString(R.string.updateNewVersion)
        s = resources.getString(R.string.about)
        s = resources.getString(R.string.accept)
        s = resources.getString(R.string.onboardingAccountCreated)
        s = resources.getString(R.string.actualSize)
        s = resources.getString(R.string.add)
        s = resources.getString(R.string.membersAddAccountIdOrOns)
        s = resources.getString(R.string.promote)
        s = resources.getString(R.string.adminPromote)
        s = resources.getString(R.string.adminAddAsAdmin)
        s = resources.getString(R.string.adminPromoteToAdmin)
        s = resources.getString(R.string.attachmentsAdd)
        s = resources.getString(R.string.conversationsAddToHome)
        s = resources.getString(R.string.conversationsAddedToHome)
        s = resources.getString(R.string.adminPromotionFailed)
        s = resources.getString(R.string.adminPromotionSent)
        s = resources.getString(R.string.adminSettings)
        s = resources.getString(R.string.adminCannotBeRemoved)
        s = resources.getString(R.string.conversationsSettingsAllMedia)
        s = resources.getString(R.string.notificationsAllMessages)
        s = resources.getString(R.string.permissionsMicrophoneDescription)
        s = resources.getString(R.string.clearDataErrorDescriptionGeneric)
        s = resources.getString(R.string.errorUnknown)
        s = resources.getString(R.string.anonymous)
        s = resources.getString(R.string.updateApp)
        s = resources.getString(R.string.sessionAppearance)
        s = resources.getString(R.string.adminPromoteTwoDescription)
        s = resources.getString(R.string.adminPromoteMoreDescription)
        s = resources.getString(R.string.adminPromoteDescription)
        s = resources.getString(R.string.blockDescription)
        s = resources.getString(R.string.clearMessagesGroupDescription)
        s = resources.getString(R.string.clearMessagesGroupAdminDescription)
        s = resources.getString(R.string.attachmentsClearAllDescription)
        s = resources.getString(R.string.messageRequestsClearAllExplanation)
        s = resources.getString(R.string.clearMessagesChatDescription)
        s = resources.getString(R.string.clearMessagesNoteToSelfDescription)
        s = resources.getString(R.string.clearMessagesCommunity)
        s = resources.getString(R.string.clearDeviceDescription)
        s = resources.getString(R.string.groupDeleteDescription)
        s = resources.getString(R.string.contactDeleteDescription)
        s = resources.getString(R.string.deleteMessagesDescriptionEveryone)
        s = resources.getString(R.string.groupInviteDelete)
        s = resources.getString(R.string.deleteMessageDescriptionDevice)
        s = resources.getString(R.string.deleteMessagesDescriptionDevice)
        s = resources.getString(R.string.messageRequestsDelete)
        s = resources.getString(R.string.deleteMessageDescriptionEveryone)
        s = resources.getString(R.string.conversationsDeleteDescription)
        s = resources.getString(R.string.clearDeviceAndNetworkConfirm)
        s = resources.getString(R.string.noteToSelfHideDescription)
        s = resources.getString(R.string.communityJoinDescription)
        s = resources.getString(R.string.communityLeaveDescription)
        s = resources.getString(R.string.groupLeaveDescription)
        s = resources.getString(R.string.groupLeaveDescriptionAdmin)
        s = resources.getString(R.string.urlOpenDescription)
        s = resources.getString(R.string.recoveryPasswordHidePermanentlyDescription2)
        s = resources.getString(R.string.blockUnblockDescription)
        s = resources.getString(R.string.attachment)
        s = resources.getString(R.string.attachmentsExpired)
        s = resources.getString(R.string.audio)
        s = resources.getString(R.string.authenticateToOpen)
        s = resources.getString(R.string.authenticateNotAccessed)
        s = resources.getString(R.string.authenticateFailed)
        s = resources.getString(R.string.attachmentsAutoDownloadModalTitle)
        s = resources.getString(R.string.appearanceAutoDarkMode)
        s = resources.getString(R.string.permissionsAutoUpdate)
        s = resources.getString(R.string.attachmentsAutoDownload)
        s = resources.getString(R.string.permissionsAutoUpdateDescription)
        s = resources.getString(R.string.attachmentsAutoDownloadDescription)
        s = resources.getString(R.string.conversationsAutoplayAudioMessage)
        s = resources.getString(R.string.conversationsAutoplayAudioMessageDescription)
        s = resources.getString(R.string.banErrorFailed)
        s = resources.getString(R.string.banUser)
        s = resources.getString(R.string.block)
        s = resources.getString(R.string.blockBlockedUser)
        s = resources.getString(R.string.conversationsBlockedContacts)
        s = resources.getString(R.string.onboardingTosPrivacy)
        s = resources.getString(R.string.call)
        s = resources.getString(R.string.callsInProgress)
        s = resources.getString(R.string.callsPermissionsRequired)
        s = resources.getString(R.string.callsSettings)
        s = resources.getString(R.string.contentDescriptionCamera)
        s = resources.getString(R.string.cameraErrorUnavailable)
        s = resources.getString(R.string.attachmentsErrorNoApp)
        s = resources.getString(R.string.cancel)
        s = resources.getString(R.string.attachmentsErrorTypes)
        s = resources.getString(R.string.updateError)
        s = resources.getString(R.string.passwordChange)
        s = resources.getString(R.string.passwordChangeDescription)
        s = resources.getString(R.string.nicknameDescription)
        s = resources.getString(R.string.appearanceThemesClassicDark)
        s = resources.getString(R.string.appearanceThemesClassicLight)
        s = resources.getString(R.string.clear)
        s = resources.getString(R.string.clearAll)
        s = resources.getString(R.string.attachmentsClearAll)
        s = resources.getString(R.string.clearDataAll)
        s = resources.getString(R.string.clearMessages)
        s = resources.getString(R.string.sessionClearData)
        s = resources.getString(R.string.clearDevice)
        s = resources.getString(R.string.clearDeviceAndNetwork)
        s = resources.getString(R.string.clearDeviceOnly)
        s = resources.getString(R.string.clearMessagesForEveryone)
        s = resources.getString(R.string.clearMessagesForMe)
        s = resources.getString(R.string.attachmentsClickToDownload)
        s = resources.getString(R.string.close)
        s = resources.getString(R.string.closeWindow)
        s = resources.getString(R.string.attachmentsCollapseOptions)
        s = resources.getString(R.string.attachmentsCollecting)
        s = resources.getString(R.string.communityError)
        s = resources.getString(R.string.communityInvitation)
        s = resources.getString(R.string.communityUrl)
        s = resources.getString(R.string.passwordConfirm)
        s = resources.getString(R.string.callsConnecting)
        s = resources.getString(R.string.contactContacts)
        s = resources.getString(R.string.continue)
        s = resources.getString(R.string.conversationsDeleted)
        s = resources.getString(R.string.sessionConversations)
        s = resources.getString(R.string.copied)
        s = resources.getString(R.string.copy)
        s = resources.getString(R.string.accountIDCopy)
        s = resources.getString(R.string.communityUrlCopy)
        s = resources.getString(R.string.errorCopyAndQuit)
        s = resources.getString(R.string.messageCopy)
        s = resources.getString(R.string.urlCopy)
        s = resources.getString(R.string.groupErrorJoin)
        s = resources.getString(R.string.groupErrorLeave)
        s = resources.getString(R.string.create)
        s = resources.getString(R.string.onboardingAccountCreate)
        s = resources.getString(R.string.groupCreate)
        s = resources.getString(R.string.passwordCreate)
        s = resources.getString(R.string.onboardingBubbleCreatingAnAccountIsEasy)
        s = resources.getString(R.string.cut)
        s = resources.getString(R.string.clearDataError)
        s = resources.getString(R.string.clearDataErrorDescription2)
        s = resources.getString(R.string.clearDataErrorDescription1)
        s = resources.getString(R.string.errorDatabase)
        s = resources.getString(R.string.decline)
        s = resources.getString(R.string.default)
        s = resources.getString(R.string.delete)
        s = resources.getString(R.string.contactDelete)
        s = resources.getString(R.string.conversationsDelete)
        s = resources.getString(R.string.groupDelete)
        s = resources.getString(R.string.deleteMessage)
        s = resources.getString(R.string.deleteMessages)
        s = resources.getString(R.string.conversationsMessageTrimmingTrimCommunitiesDescription)
        s = resources.getString(R.string.disappearingMessagesDeleteType)
        s = resources.getString(R.string.deleting)
        s = resources.getString(R.string.onionRoutingPathDestination)
        s = resources.getString(R.string.disappearingMessagesDisappear)
        s = resources.getString(R.string.disappearingMessagesDisappearAfterRead)
        s = resources.getString(R.string.disappearingMessagesDisappearAfterSend)
        s = resources.getString(R.string.disappearingMessages)
        s = resources.getString(R.string.dismiss)
        s = resources.getString(R.string.profileDisplayPicture)
        s = resources.getString(R.string.linkPreviewsFirstDescription)
        s = resources.getString(R.string.done)
        s = resources.getString(R.string.download)
        s = resources.getString(R.string.downloading)
        s = resources.getString(R.string.draft)
        s = resources.getString(R.string.attachmentsDuration)
        s = resources.getString(R.string.edit)
        s = resources.getString(R.string.groupEdit)
        s = resources.getString(R.string.emojiAndSymbols)
        s = resources.getString(R.string.enable)
        s = resources.getString(R.string.linkPreviewsEnable)
        s = resources.getString(R.string.conversationsSpellCheckDescription)
        s = resources.getString(R.string.callsVoiceAndVideoToggleDescription)
        s = resources.getString(R.string.displayNameEnter)
        s = resources.getString(R.string.groupDescriptionEnter)
        s = resources.getString(R.string.accountIdEnter)
        s = resources.getString(R.string.accountIdOrOnsEnter)
        s = resources.getString(R.string.communityEnterUrl)
        s = resources.getString(R.string.groupNameEnter)
        s = resources.getString(R.string.nicknameEnter)
        s = resources.getString(R.string.passwordEnter)
        s = resources.getString(R.string.accountIdEnterYourFriends)
        s = resources.getString(R.string.recoveryPasswordEnter)
        s = resources.getString(R.string.onionRoutingPathEntryNode)
        s = resources.getString(R.string.error)
        s = resources.getString(R.string.attachmentsErrorLoad)
        s = resources.getString(R.string.attachmentsErrorSending)
        s = resources.getString(R.string.helpReportABugExportLogs)
        s = resources.getString(R.string.groupInviteFailedUser)
        s = resources.getString(R.string.groupInviteFailedTwo)
        s = resources.getString(R.string.groupInviteFailedMore)
        s = resources.getString(R.string.groupLeaveErrorFailed)
        s = resources.getString(R.string.adminPromotionFailedDescription)
        s = resources.getString(R.string.adminPromotionFailedDescriptionMore)
        s = resources.getString(R.string.adminPromotionFailedDescriptionMany)
        s = resources.getString(R.string.adminRemoveFailed)
        s = resources.getString(R.string.messageStatusFailedToSend)
        s = resources.getString(R.string.passwordFailed)
        s = resources.getString(R.string.messageStatusFailedToSync)
        s = resources.getString(R.string.failures)
        s = resources.getString(R.string.helpFAQ)
        s = resources.getString(R.string.notificationsFastMode)
        s = resources.getString(R.string.file)
        s = resources.getString(R.string.attachmentsFileId)
        s = resources.getString(R.string.attachmentsFileSize)
        s = resources.getString(R.string.attachmentsFileType)
        s = resources.getString(R.string.files)
        s = resources.getString(R.string.attachmentsErrorSize)
        s = resources.getString(R.string.callsCannotStart)
        s = resources.getString(R.string.qrYoursDescription)
        s = resources.getString(R.string.from)
        s = resources.getString(R.string.gif)
        s = resources.getString(R.string.notificationsGoToAndroidSettings)
        s = resources.getString(R.string.notificationsGoToDevice)
        s = resources.getString(R.string.updateReleaseNotes)
        s = resources.getString(R.string.supportGoTo)
        s = resources.getString(R.string.cameraGrantAccess)
        s = resources.getString(R.string.groupDisplayPictureUpdated)
        s = resources.getString(R.string.groupInviteSuccessful)
        s = resources.getString(R.string.groupMembers)
        s = resources.getString(R.string.groupName)
        s = resources.getString(R.string.groupNameNew)
        s = resources.getString(R.string.groupNameUpdated)
        s = resources.getString(R.string.groupUpdated)
        s = resources.getString(R.string.groupAddMemberMaximum)
        s = resources.getString(R.string.groupLegacyBanner)
        s = resources.getString(R.string.sessionHelp)
        s = resources.getString(R.string.helpHelpUsTranslateSession)
        s = resources.getString(R.string.hide)
        s = resources.getString(R.string.appearanceHideMenuBar)
        s = resources.getString(R.string.noteToSelfHide)
        s = resources.getString(R.string.hideOthers)
        s = resources.getString(R.string.recoveryPasswordHideRecoveryPassword)
        s = resources.getString(R.string.recoveryPasswordHidePermanently)
        s = resources.getString(R.string.onboardingHitThePlusButton)
        s = resources.getString(R.string.appearancePreview1)
        s = resources.getString(R.string.onboardingAccountExists)
        s = resources.getString(R.string.appearancePreview3)
        s = resources.getString(R.string.appearancePreview2)
        s = resources.getString(R.string.incognitoKeyboard)
        s = resources.getString(R.string.callsIncoming)
        s = resources.getString(R.string.passwordIncorrect)
        s = resources.getString(R.string.recoveryPasswordErrorTitle)
        s = resources.getString(R.string.info)
        s = resources.getString(R.string.invalidShortcut)
        s = resources.getString(R.string.communityEnterUrlErrorInvalid)
        s = resources.getString(R.string.membersInviteTitle)
        s = resources.getString(R.string.accountIdOrOnsInvite)
        s = resources.getString(R.string.sessionInviteAFriend)
        s = resources.getString(R.string.groupInviteFailed)
        s = resources.getString(R.string.membersInvite)
        s = resources.getString(R.string.groupInviteSent)
        s = resources.getString(R.string.displayNameDescription)
        s = resources.getString(R.string.join)
        s = resources.getString(R.string.communityJoin)
        s = resources.getString(R.string.communityJoined)
        s = resources.getString(R.string.permissionsKeepInSystemTray)
        s = resources.getString(R.string.later)
        s = resources.getString(R.string.learnMore)
        s = resources.getString(R.string.leave)
        s = resources.getString(R.string.communityLeave)
        s = resources.getString(R.string.groupLeave)
        s = resources.getString(R.string.notificationsLedColor)
        s = resources.getString(R.string.linkPreviews)
        s = resources.getString(R.string.recoveryPasswordDescription)
        s = resources.getString(R.string.loading)
        s = resources.getString(R.string.attachmentsLoadingNewer)
        s = resources.getString(R.string.attachmentsLoadingOlder)
        s = resources.getString(R.string.loadAccountProgressMessage)
        s = resources.getString(R.string.lockApp)
        s = resources.getString(R.string.lockAppStatus)
        s = resources.getString(R.string.messageMarkRead)
        s = resources.getString(R.string.messageMarkUnread)
        s = resources.getString(R.string.followSystemSettings)
        s = resources.getString(R.string.max)
        s = resources.getString(R.string.media)
        s = resources.getString(R.string.contentDescriptionMediaMessage)
        s = resources.getString(R.string.attachmentsMediaSaved)
        s = resources.getString(R.string.notificationsMentionsOnly)
        s = resources.getString(R.string.message)
        s = resources.getString(R.string.contentDescriptionMessageComposition)
        s = resources.getString(R.string.deleteMessageDeleted)
        s = resources.getString(R.string.messageErrorDelivery)
        s = resources.getString(R.string.messageInfo)
        s = resources.getString(R.string.messageErrorLimit)
        s = resources.getString(R.string.notificationsMessage)
        s = resources.getString(R.string.sessionMessageRequests)
        s = resources.getString(R.string.conversationsMessageTrimming)
        s = resources.getString(R.string.messages)
        s = resources.getString(R.string.deleteMessagesDeleted)
        s = resources.getString(R.string.disappearingMessagesDisappearAfterReadDescription)
        s = resources.getString(R.string.disappearingMessagesDisappearAfterSendDescription)
        s = resources.getString(R.string.permissionsMicrophone)
        s = resources.getString(R.string.permissionsMicrophoneAccessRequired)
        s = resources.getString(R.string.minimize)
        s = resources.getString(R.string.callsMissedCallFrom)
        s = resources.getString(R.string.notificationsMostRecent)
        s = resources.getString(R.string.attachmentsMoveAndScale)
        s = resources.getString(R.string.notificationsMute)
        s = resources.getString(R.string.notificationsMuted)
        s = resources.getString(R.string.attachmentsNa)
        s = resources.getString(R.string.notificationsContentShowNameAndContent)
        s = resources.getString(R.string.notificationsContentShowNameOnly)
        s = resources.getString(R.string.conversationsNew)
        s = resources.getString(R.string.messageNew)
        s = resources.getString(R.string.messageNewMessages)
        s = resources.getString(R.string.next)
        s = resources.getString(R.string.no)
        s = resources.getString(R.string.audioNoInput)
        s = resources.getString(R.string.audioNoOutput)
        s = resources.getString(R.string.blockBlockedNone)
        s = resources.getString(R.string.cameraErrorNotFound)
        s = resources.getString(R.string.notificationsContentShowNoNameOrContent)
        s = resources.getString(R.string.none)
        s = resources.getString(R.string.messageRequestsNonePending)
        s = resources.getString(R.string.searchMatchesNoneSpecific)
        s = resources.getString(R.string.searchMatchesNone)
        s = resources.getString(R.string.noSuggestions)
        s = resources.getString(R.string.notNow)
        s = resources.getString(R.string.noteToSelf)
        s = resources.getString(R.string.notificationsContent)
        s = resources.getString(R.string.notificationsStrategy)
        s = resources.getString(R.string.notificationsStyle)
        s = resources.getString(R.string.sessionNotifications)
        s = resources.getString(R.string.appearanceThemesOceanDark)
        s = resources.getString(R.string.appearanceThemesOceanLight)
        s = resources.getString(R.string.off)
        s = resources.getString(R.string.okay)
        s = resources.getString(R.string.waitOneMoment)
        s = resources.getString(R.string.disappearingMessagesOnlyAdmins)
        s = resources.getString(R.string.communityErrorDescription)
        s = resources.getString(R.string.open)
        s = resources.getString(R.string.urlOpen)
        s = resources.getString(R.string.databaseOptimizing)
        s = resources.getString(R.string.communityJoinOfficial)
        s = resources.getString(R.string.messageErrorOriginal)
        s = resources.getString(R.string.other)
        s = resources.getString(R.string.passwordErrorLength)
        s = resources.getString(R.string.passwordError)
        s = resources.getString(R.string.passwordErrorMatch)
        s = resources.getString(R.string.paste)
        s = resources.getString(R.string.onionRoutingPath)
        s = resources.getString(R.string.recoveryPasswordHideRecoveryPasswordDescription)
        s = resources.getString(R.string.permissionsRequired)
        s = resources.getString(R.string.sessionPermissions)
        s = resources.getString(R.string.photo)
        s = resources.getString(R.string.displayNameNew)
        s = resources.getString(R.string.displayNamePick)
        s = resources.getString(R.string.pin)
        s = resources.getString(R.string.pinConversation)
        s = resources.getString(R.string.communityEnterUrlErrorInvalidDescription)
        s = resources.getString(R.string.recoveryPasswordErrorMessageGeneric)
        s = resources.getString(R.string.groupNameEnterPlease)
        s = resources.getString(R.string.groupNameEnterShorter)
        s = resources.getString(R.string.passwordEnterCurrent)
        s = resources.getString(R.string.passwordEnterNew)
        s = resources.getString(R.string.searchEnter)
        s = resources.getString(R.string.displayNameErrorDescription)
        s = resources.getString(R.string.displayNameErrorDescriptionShorter)
        s = resources.getString(R.string.groupCreateErrorNoMembers)
        s = resources.getString(R.string.attachmentsErrorSeparate)
        s = resources.getString(R.string.preview)
        s = resources.getString(R.string.linkPreviewsErrorUnsecure)
        s = resources.getString(R.string.appearancePrimaryColor)
        s = resources.getString(R.string.sessionPrivacy)
        s = resources.getString(R.string.onboardingBubblePrivacyInYourPocket)
        s = resources.getString(R.string.profile)
        s = resources.getString(R.string.lockAppQuickResponse)
        s = resources.getString(R.string.read)
        s = resources.getString(R.string.readReceipts)
        s = resources.getString(R.string.received)
        s = resources.getString(R.string.messageErrorOld)
        s = resources.getString(R.string.recommended)
        s = resources.getString(R.string.callsReconnecting)
        s = resources.getString(R.string.sessionRecoveryPassword)
        s = resources.getString(R.string.redo)
        s = resources.getString(R.string.remove)
        s = resources.getString(R.string.adminRemove)
        s = resources.getString(R.string.adminRemoveAsAdmin)
        s = resources.getString(R.string.groupRemoveMessages)
        s = resources.getString(R.string.groupRemoveUsersMessages)
        s = resources.getString(R.string.nicknameRemove)
        s = resources.getString(R.string.passwordRemove)
        s = resources.getString(R.string.passwordRemoveDescription)
        s = resources.getString(R.string.groupRemoveUserOnly)
        s = resources.getString(R.string.groupRemoveUsersOnly)
        s = resources.getString(R.string.reply)
        s = resources.getString(R.string.messageReplyingTo)
        s = resources.getString(R.string.helpReportABug)
        s = resources.getString(R.string.incognitoKeyboardDescription)
        s = resources.getString(R.string.screenshotNotificationsDescription)
        s = resources.getString(R.string.lockAppDescriptionAndroid)
        s = resources.getString(R.string.passwordDescription)
        s = resources.getString(R.string.lockAppDescriptionIos)
        s = resources.getString(R.string.resend)
        s = resources.getString(R.string.attachmentsResolution)
        s = resources.getString(R.string.resolving)
        s = resources.getString(R.string.restart)
        s = resources.getString(R.string.retry)
        s = resources.getString(R.string.callsRinging)
        s = resources.getString(R.string.save)
        s = resources.getString(R.string.helpReportABugExportLogsSaveToDesktopDescription)
        s = resources.getString(R.string.helpReportABugExportLogsSaveToDesktop)
        s = resources.getString(R.string.saved)
        s = resources.getString(R.string.savedMessages)
        s = resources.getString(R.string.saving)
        s = resources.getString(R.string.qrScan)
        s = resources.getString(R.string.screenSecurity)
        s = resources.getString(R.string.screenshotNotifications)
        s = resources.getString(R.string.search)
        s = resources.getString(R.string.searchContacts)
        s = resources.getString(R.string.searchConversation)
        s = resources.getString(R.string.searchMembers)
        s = resources.getString(R.string.searchSearching)
        s = resources.getString(R.string.typingIndicatorsDescription)
        s = resources.getString(R.string.select)
        s = resources.getString(R.string.selectAll)
        s = resources.getString(R.string.contactSelect)
        s = resources.getString(R.string.messageSelect)
        s = resources.getString(R.string.send)
        s = resources.getString(R.string.linkPreviewsSend)
        s = resources.getString(R.string.conversationsSendWithEnterKey)
        s = resources.getString(R.string.sending)
        s = resources.getString(R.string.messageRequestGroupInviteDescription)
        s = resources.getString(R.string.messageRequestsAcceptDescription)
        s = resources.getString(R.string.adminSendingPromotion)
        s = resources.getString(R.string.groupInviteSending)
        s = resources.getString(R.string.disappearingMessagesSent)
        s = resources.getString(R.string.onionRoutingPathServiceNode)
        s = resources.getString(R.string.sessionMessenger)
        s = resources.getString(R.string.permissionsKeepInSystemTrayDescription)
        s = resources.getString(R.string.updateErrorDescription)
        s = resources.getString(R.string.onionRoutingPathDescription)
        s = resources.getString(R.string.onboardingBubbleSessionIsEngineered)
        s = resources.getString(R.string.lockAppLocked)
        s = resources.getString(R.string.lockAppUnlocked)
        s = resources.getString(R.string.cameraGrantAccessQr)
        s = resources.getString(R.string.cameraGrantAccessDenied)
        s = resources.getString(R.string.cameraGrantAccessDescription)
        s = resources.getString(R.string.permissionsMicrophoneAccessRequiredAndroid)
        s = resources.getString(R.string.cameraGrantAccessStorage)
        s = resources.getString(R.string.updateSession)
        s = resources.getString(R.string.notificationsSlowModeDescription)
        s = resources.getString(R.string.set)
        s = resources.getString(R.string.displayNameSet)
        s = resources.getString(R.string.profileSetDisplayPicture)
        s = resources.getString(R.string.groupInformationSet)
        s = resources.getString(R.string.groupSetDisplayPicture)
        s = resources.getString(R.string.nicknameSet)
        s = resources.getString(R.string.passwordSet)
        s = resources.getString(R.string.sessionSettings)
        s = resources.getString(R.string.share)
        s = resources.getString(R.string.membersInviteSend)
        s = resources.getString(R.string.membersInviteSendMultiple)
        s = resources.getString(R.string.membersInviteShareMessageHistory)
        s = resources.getString(R.string.membersInviteShareNewMessagesOnly)
        s = resources.getString(R.string.helpReportABugDescription)
        s = resources.getString(R.string.shareToSession)
        s = resources.getString(R.string.show)
        s = resources.getString(R.string.showAll)
        s = resources.getString(R.string.linkPreviewsDescription)
        s = resources.getString(R.string.readReceiptsDescription)
        s = resources.getString(R.string.contactUserDetails)
        s = resources.getString(R.string.messageVoiceSlideToCancel)
        s = resources.getString(R.string.notificationsSlowMode)
        s = resources.getString(R.string.recoveryPasswordErrorMessageIncorrect)
        s = resources.getString(R.string.notificationsSound)
        s = resources.getString(R.string.notificationsSoundDescription)
        s = resources.getString(R.string.conversationsSpellCheck)
        s = resources.getString(R.string.messageNewDescription)
        s = resources.getString(R.string.dictationStart)
        s = resources.getString(R.string.stickers)
        s = resources.getString(R.string.helpSupport)
        s = resources.getString(R.string.messageStatusSyncing)
        s = resources.getString(R.string.attachmentsTapToDownload)
        s = resources.getString(R.string.lockAppUnlock)
        s = resources.getString(R.string.conversationsSendWithEnterKeyDescription)
        s = resources.getString(R.string.notificationsContentDescription)
        s = resources.getString(R.string.qrNotAccountId)
        s = resources.getString(R.string.qrNotRecoveryPassword)
        s = resources.getString(R.string.recoveryPasswordErrorMessageShort)
        s = resources.getString(R.string.updateDownloaded)
        s = resources.getString(R.string.appearanceThemes)
        s = resources.getString(R.string.adminRemoveCommunityNone)
        s = resources.getString(R.string.conversationsEmpty)
        s = resources.getString(R.string.groupMembersNone)
        s = resources.getString(R.string.onboardingMessageNotificationExplaination)
        s = resources.getString(R.string.updateNewVersionDescription)
        s = resources.getString(R.string.accountIdErrorInvalid)
        s = resources.getString(R.string.waitFewMinutes)
        s = resources.getString(R.string.attachmentsErrorNotSupported)
        s = resources.getString(R.string.recoveryPasswordWarningSendDescription)
        s = resources.getString(R.string.messageEmpty)
        s = resources.getString(R.string.attachmentsThisMonth)
        s = resources.getString(R.string.disappearingMessagesDescription)
        s = resources.getString(R.string.urlOpenBrowswer)
        s = resources.getString(R.string.clearDataAllDescription)
        s = resources.getString(R.string.disappearingMessagesTimer)
        s = resources.getString(R.string.recoveryPasswordExplanation)
        s = resources.getString(R.string.developerToolsToggle)
        s = resources.getString(R.string.fullScreenToggle)
        s = resources.getString(R.string.authenticateFailedTooManyAttempts)
        s = resources.getString(R.string.conversationsMessageTrimmingTrimCommunities)
        s = resources.getString(R.string.tryAgain)
        s = resources.getString(R.string.typingIndicators)
        s = resources.getString(R.string.linkPreviewsErrorLoad)
        s = resources.getString(R.string.attachmentsErrorOpen)
        s = resources.getString(R.string.audioUnableToPlay)
        s = resources.getString(R.string.videoErrorPlay)
        s = resources.getString(R.string.audioUnableToRecord)
        s = resources.getString(R.string.attachmentsImageErrorMetadata)
        s = resources.getString(R.string.attachmentsSaveError)
        s = resources.getString(R.string.attachmentsErrorNumber)
        s = resources.getString(R.string.banUnbanErrorFailed)
        s = resources.getString(R.string.banUnbanUser)
        s = resources.getString(R.string.blockUnblock)
        s = resources.getString(R.string.blockUnblockedUser)
        s = resources.getString(R.string.blockBlockedDescription)
        s = resources.getString(R.string.undo)
        s = resources.getString(R.string.onionRoutingPathUnknownCountry)
        s = resources.getString(R.string.attachmentsAlbumUnnamed)
        s = resources.getString(R.string.pinUnpin)
        s = resources.getString(R.string.pinUnpinConversation)
        s = resources.getString(R.string.messageUnread)
        s = resources.getString(R.string.uploading)
        s = resources.getString(R.string.useFastMode)
        s = resources.getString(R.string.banUserBanned)
        s = resources.getString(R.string.updateVersion)
        s = resources.getString(R.string.notificationsVibrate)
        s = resources.getString(R.string.video)
        s = resources.getString(R.string.view)
        s = resources.getString(R.string.recoveryPasswordView)
        s = resources.getString(R.string.qrView)
        s = resources.getString(R.string.callsVoiceAndVideo)
        s = resources.getString(R.string.callsVoiceAndVideoBeta)
        s = resources.getString(R.string.callsNotificationsRequired)
        s = resources.getString(R.string.messageVoice)
        s = resources.getString(R.string.warning)
        s = resources.getString(R.string.onsErrorNotRecognised)
        s = resources.getString(R.string.displayNameErrorNew)
        s = resources.getString(R.string.onsErrorUnableToSearch)
        s = resources.getString(R.string.helpWedLoveYourFeedback)
        s = resources.getString(R.string.onboardingBubbleWelcomeToSession)
        s = resources.getString(R.string.window)
        s = resources.getString(R.string.recoveryPasswordHidePermanentlyDescription1)
        s = resources.getString(R.string.attachmentsAutoDownloadModalDescription)
        s = resources.getString(R.string.helpReportABugExportLogsDescription)
        s = resources.getString(R.string.groupRemoveMoreDescription)
        s = resources.getString(R.string.groupRemoveTwoDescription)
        s = resources.getString(R.string.groupRemoveDescription)
        s = resources.getString(R.string.membersInviteShareTwoDescription)
        s = resources.getString(R.string.membersInviteShareMoreDescription)
        s = resources.getString(R.string.membersInviteShareDescription)
        s = resources.getString(R.string.yes)
        s = resources.getString(R.string.onionRoutingPathYou)
        s = resources.getString(R.string.communityJoinedAlready)
        s = resources.getString(R.string.groupOnlyAdmin)
        s = resources.getString(R.string.callsYouCalled)
        s = resources.getString(R.string.permissionsMicrophoneAccessRequiredDesktop)
        s = resources.getString(R.string.callsPermissionsRequiredDescription)
        s = resources.getString(R.string.onboardingBubbleNoPhoneNumber)
        s = resources.getString(R.string.contactNone)
        s = resources.getString(R.string.conversationsNone)
        s = resources.getString(R.string.attachmentsFilesEmpty)
        s = resources.getString(R.string.attachmentsMediaEmpty)
        s = resources.getString(R.string.messageRequestsNew)
        s = resources.getString(R.string.messageRequestYouHaveAccepted)
        s = resources.getString(R.string.messageRequestGroupInvite)
        s = resources.getString(R.string.groupNoMessages)
        s = resources.getString(R.string.noteToSelfEmpty)
        s = resources.getString(R.string.groupMemberYouLeft)
        s = resources.getString(R.string.notificationsIosRestart)
        s = resources.getString(R.string.callsYouMissedCallPermissions)
        s = resources.getString(R.string.callsMissed)
        s = resources.getString(R.string.lockAppEnablePasscode)
        s = resources.getString(R.string.settingsRestartDescription)
        s = resources.getString(R.string.disappearingMessagesSetYou)
        s = resources.getString(R.string.disappearingMessagesTurnedOffYou)
        s = resources.getString(R.string.disappearingMessagesUpdatedYou)
        s = resources.getString(R.string.groupInviteYou)
        s = resources.getString(R.string.groupRemovedYou)
        s = resources.getString(R.string.groupPromotedYou)
        s = resources.getString(R.string.messageRequestPendingDescription)
        s = resources.getString(R.string.linkPreviewsSendModalDescription)
        s = resources.getString(R.string.notificationsFastModeDescriptionIos)
        s = resources.getString(R.string.notificationsFastModeDescriptionAndroid)
        s = resources.getString(R.string.messageNewYouveGotMany)
        s = resources.getString(R.string.messageNewYouveGotA)
        s = resources.getString(R.string.accountIdYours)
        s = resources.getString(R.string.passwordCurrentIncorrect)
        s = resources.getString(R.string.callsVoiceAndVideoModalDescription)
        s = resources.getString(R.string.messageRequestsAccepted)
        s = resources.getString(R.string.messageRequestPending)
        s = resources.getString(R.string.passwordChangedDescription)
        s = resources.getString(R.string.passwordRemovedDescription)
        s = resources.getString(R.string.passwordSetDescription)
        s = resources.getString(R.string.appearanceZoom)
        s = resources.getString(R.string.appearanceZoomIn)
        s = resources.getString(R.string.appearanceZoomOut)
        s = resources.getString(R.string.groupMemberLeftTwo)
        s = resources.getString(R.string.groupMemberLeftMore)
        s = resources.getString(R.string.notificationsMute1Week)
        s = resources.getString(R.string.notificationsMute1Day)
        s = resources.getString(R.string.notificationsMute2Hours)
        s = resources.getString(R.string.notificationsMute1Hour)
        s = resources.getString(R.string.qrCode)
        s = resources.getString(R.string.unknown)
        s = resources.getString(R.string.attachmentsDownload)
        s = resources.getString(R.string.membersInviteSendMultiple)
        s = resources.getString(R.string.urlOpenBrowser)
    }
    */
...
//                }
    ...
    override fun startRecordingVoiceMessage() {
        if (Permissions.hasAll(this, Manifest.permission.RECORD_AUDIO)) {
            ...
            Permissions.with(this)
                ...
                .withPermanentDenialDialog(getString(R.string.permissionsMicrophoneAccessRequiredAndroid))
                .execute()
        }
    }
    ...
    override fun banAndDeleteAll(messages: Set<MessageRecord>) {
        showSessionDialog {
            ...
            button(R.string.banUser) { viewModel.banAndDeleteAll(messages.first().individualRecipient); endActionMode() }
            cancelButton(::endActionMode)
        }
    }
